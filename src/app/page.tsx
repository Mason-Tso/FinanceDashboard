    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="p-5 lg:col-span-2">
          ...
          <HoldingsPanel positions={portfolio.positions} signals={signals} />
          <p className="mt-3 text-xs text-faint">
            Signals are a quick momentum read (price vs its trend). Click a chip to filter; hover a badge for the why.
